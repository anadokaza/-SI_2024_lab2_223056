...
class SILab2Test {
    ...
    void checkMultipleCondition() {
        assertTrue(SILab2.checkCart(create(new Item("krem","0123456789",350,0.25f)),15000));

        assertFalse(SILab2.checkCart(create(new Item("dog","123456",350,0.1f)),10));

        assertFalse(SILab2.checkCart(create(new Item("milk","0756433",350,-1f)),10));
